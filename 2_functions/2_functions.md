...
### Functions: C++ ([driver.cpp](https://github.com/reparke/Programming-Language-Transition-Guide/blob/main/2_functions/c%2B%2B/driver.cpp))
...
### Functions: Python ([main.py](https://github.com/reparke/Programming-Language-Transition-Guide/blob/main/2_functions/python/main.py))
...
### Functions: Java ([Program.java](https://github.com/reparke/Programming-Language-Transition-Guide/blob/main/2_functions/java/Program.java))
